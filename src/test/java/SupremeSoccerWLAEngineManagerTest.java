...
public class SupremeSoccerWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(SupremeSoccerWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SupremeFootballIWWLA/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SupremeFootballIWWLA/InitOutcome.xml").getDocumentElement();
